...
def run(dic):
    ...
    if len(cls_box_i) == 0:
        ...
        vis_one_image(img, basename, '/home/kpatel2s/kpatel2s/link_scratch_dir/kpatel2s/model_weights/saf_fcos_weights/tmp_ver2/' + config_name, cls_box_i)


if __name__ == "__main__":

    config_name = 'nuscenes_ground_truths'
    json_file_path_gt = '/scratch/kpatel2s/datasets/nuScenes/v1.0-trainval/gt_fcos_coco_test.json'
    ...
    with open('/scratch/kpatel2s/datasets/nuScenes/v1.0-trainval/gt_fcos_coco_test.json', 'r') as f:
        dicts = json.load(f)
        dics_2 = dicts['annotations']
        dicts = dicts['images']
